...
class AddEventTest(unittest.TestCase):
	...
	def test_add_event_eid_exist(self):
		'''id已经存在'''
		payload = {'eid':1,'name':'一加4发布会','limit':2000,'address':'深圳宝体','start_time':'2021-08-09 12:00:00'}
		r = requests.post(self.base_url,data=payload)
		self.result = r.json()
	...
	def test_add_event_name_exist(self):
		'''名称已经存在'''
		payload = {'eid':11,'name':'红米Pro发布会','limit':2000,'address':'深圳宝体','start_time':'2021-08-09 12:00:00'}
		r = requests.post(self.base_url, data=payload)
		self.result = r.json()
	...
	def test_add_event_data_type_error(self):
		'''日期格式错误'''
		payload = {'eid':11,'name':'一加4手机发布会','limit':2000,'address':'深圳宝体','start_time':'2021'}
		r = requests.post(self.base_url, data=payload)
		self.result = r.json()
